...
/*
 * FRF_FAST_BUILD_NO_RESID:
 * Normal builds retain ReSID. The optional FAST build profile undefines
 * ReSID only after config.h has been included.
 */
#if defined(FRF_FAST_BUILD_NO_RESID)
# undef HAVE_RESID
