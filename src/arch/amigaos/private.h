...
struct os_s {
    ...
    /* FRF_PAL_RGB_NATIVE_V17: native PAL/RGB fullscreen state.
     * RTG/P96 output continues to use window_bitmap. Native <=8-bit output
     * renders into this indexed CPU buffer and publishes via WriteChunkyPixels. */
    UBYTE *frf_pal_native_chunky;
    ULONG frf_pal_native_bpr;
    ULONG frf_pal_native_height;
    int frf_pal_native_mode;
