...
/* FRF_V18_FIX4_MENU: private label ID; resolved in intl.c. */
#define IDMS_FRF_SELECT_SCREENMODE 32512
...
enum {
    ...
    IDM_TOGGLE_FULLSCREEN, IDM_FRF_SELECT_SCREENMODE, IDM_TOGGLE_VIDEOCACHE, IDM_TOGGLE_DOUBLESIZE,
