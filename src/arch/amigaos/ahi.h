...
extern s32 ahi_play_samples(void *data, s32 samples, s64 time, s32 wait);
extern s32 ahi_samples_buffered(void);
extern s32 ahi_samples_free(void);
extern void ahi_pause(void);
extern void ahi_release(void);
extern void ahi_continue(void);
extern s32 ahi_resume(void); /* FRF_HARD_PAUSE_AHI_RELEASE */
